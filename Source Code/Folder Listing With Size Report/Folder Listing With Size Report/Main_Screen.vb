...
Public Class Main_Screen
    ...
    Private bytes As Long = 0
    Private currentfilename As String = ""
    Private currentfoldername As String = ""
    Private filecount As Long = 0
    Private foldercount As Long = 0
    Private statusmessage As String = ""
    Private highestPercentageReached As Integer = 0
    Private totalfilesprecount As Long = 0
    Private totalfoldersprecount As Long = 0
    Private datelaunched As Date = Now()
    Private savefilename As String = ""
    Private pretestdone As Boolean = False
    Private depthstep As Integer = 0
    Private predepthstep As Integer = 0
    Private bytesResults As ArrayList
